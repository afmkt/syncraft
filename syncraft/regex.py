...
class RE(G):
    ...
    def group(): # type: ignore
        ...
        return S.alt(
            ...
            S.seq2(partial(GroupAtom, kind=GroupKind.FLAGS), S.lex(B.lit("(?")), inline_flags=+RE.inline_flags, _=RE.rparen),
            ...
            S.seq2(partial(UnsupportedFeature, feature="comment group"), 
                   S.lex(B.lit("(?#")), 
                   comment=+RE.comment,
                   _=RE.rparen),
