...
@overload
def lazy(thunk: str) -> Callable[[Callable[[Any], Syntax]], LazyHolder]: ...
@overload
def lazy(thunk: bool) -> Callable[[Callable[[Any], Syntax]], LazyHolder]: ...
@overload
def lazy(thunk: Callable[[Any], Syntax]) -> LazyHolder: ...
def lazy(thunk: str | Callable[[Any], Syntax] | bool) -> LazyHolder | Callable[[Any], LazyHolder]:
    """
